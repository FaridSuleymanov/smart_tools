...
function buildEnvContext(
  ...
  if (airStations.length > 0) {
    ...
    // Find worst reading across all stations
...
export default function MAGISybil() {
  ...
  const getMapBounds = useCallback(() => {
    // Access bounds via the ThreatMap's exposed __getBounds
  ...
  const runAnalysis = useCallback(async () => {
    ...
    // Build environmental context from currently loaded data
    const envContext = buildEnvContext(fires, totalFirePts, airStations);
  ...
  }, [query, location, history, fires, totalFirePts, airStations]);
  ...
  // RENDER
  // ═══════════════════════════════════════════════════════════════
  const hasEnvData = fires.length > 0 || airStations.length > 0;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <header className="mb-6">
          ...
          <p className="text-zinc-500 text-sm font-mono mt-1">
            v2.1 — FIRMS • OpenAQ • Multi-Agent Analysis • Live Threats
          </p>
        ...
        {activeTab === 'advisor' && (
          <div className="mt-6 grid lg:grid-cols-5 gap-6">
            <div className="lg:col-span-2 space-y-4">
              ...
              <p className="text-[10px] text-zinc-600 font-mono text-center">Ctrl+Enter to submit • Load FIRMS/OpenAQ data from Map tab first for richer analysis</p>
            </div>
          ...
          <div className="mt-6 grid lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              ...
              <Card className="p-4 space-y-3">
                ...
                {/* Toggle visibility */}
                {(fires.length > 0 || airStations.length > 0) && (
